...
<div>        <Footer.Title title="Company" />
        ...
        <div className='w-full sm:flex sm:items-center sm:justify-between'>
          ...
          />
          <h1 class="flex items-center text-sm sm:text-2xl font-extrabold dark:text-white">Mobile
          <img class="h-auto max-w-lg transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0 dark:grayscale:-0" src="/slike/auto.png" width="100"height="100" ></img>    
          <span class="bg-blue-100 text-blue-800  text-xl font-semibold me-2 px-2.5 py-0.5 rounded dark:bg-amber-500 dark:text-black ms-2">Rent&Sell</span></h1>
