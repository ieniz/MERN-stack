    ...
    <Footer container className='shadow-2xl rounded-2xl bg-gradient-to-b from-transparent via-transparent dark:to-gray-950'>
      <div className='w-full max-w-7xl mx-auto'>
        ...
        <div className='hidden justify-between sm:flex'>
          ...
          <div>
            <Footer.Title title="Kompanija" />
            <Footer.Link href="#">O nama</Footer.Link>
            <Footer.Link href="#">Centar brenda</Footer.Link>
          </div>

          <div>
            <Footer.Title title='Preuzimanje' />
            <Footer.Link href='#'>Android</Footer.Link>
            <Footer.Link href='#'>IOS</Footer.Link>
          </div>

          <div>
            <Footer.Title title="Centar za pomoć" />
            <Footer.Link href="#">Discord Server</Footer.Link>
            <Footer.Link href="#">Kontaktirajte nas</Footer.Link>
          </div>

          <div>
            <Footer.Title title='Pravno' />
            <Footer.Link href='#'>Politika privatnosti</Footer.Link>
            <Footer.Link href='#'>Uslovi korištenja</Footer.Link>
          </div>
